      ...
      <Card>
        <CardContent className="p-8 text-center">
          <div className="h-12 w-12 rounded-geist-full bg-geist-error-soft dark:bg-neutral-800 flex items-center justify-center mx-auto mb-3">
            <FolderGit2 className="h-5 w-5 text-geist-error dark:text-neutral-300" />
          </div>
      ...
      <Card className="border border-dashed border-geist-hairline dark:border-neutral-700">
        <CardContent className="p-10 text-center">
          <div className="h-12 w-12 rounded-geist-full bg-geist-canvas-soft-2 dark:bg-neutral-800 flex items-center justify-center mx-auto mb-4">
            <FolderGit2 className="h-6 w-6 text-geist-mute dark:text-neutral-300" />
          </div>
          <h3 className="text-body-md-strong text-geist-ink dark:text-white mb-1">
            No repositories yet.
          </h3>
          <p className="text-body-sm text-geist-body dark:text-neutral-300 max-w-sm mx-auto">
          ...
          <CardContent className="p-5">
            <div className="flex items-start justify-between mb-3">
              ...
              <button
                ...
                className="p-1.5 rounded-geist-sm text-geist-mute hover:text-geist-error hover:bg-geist-error-soft dark:text-neutral-300 dark:hover:text-white dark:hover:bg-neutral-800 transition-all opacity-0 group-hover:opacity-100"
            ...
            <div className="text-body-sm text-geist-body dark:text-neutral-300 mb-3 line-clamp-2">
              {editingDescId === repo.id ? (
                <span className="flex gap-1.5">
                  ...
                  <button
                    ...
                    className="px-2 py-1 text-xs rounded-geist-sm border border-geist-hairline dark:border-neutral-700 text-geist-body dark:text-neutral-300 hover:bg-geist-canvas-soft dark:hover:bg-neutral-800"
                  >
                    Cancel
                  </button>
                </span>
              ...
              {editingTagId === repo.id ? (
                    ...
                    <button
                      ...
                      className={`px-2 py-0.5 text-[10px] rounded-geist-full border transition-all ${
                        tag === repo.academic_tag
                          ...
                          : "bg-geist-canvas text-geist-body border-geist-hairline hover:border-geist-hairline-strong dark:bg-neutral-900 dark:text-neutral-300 dark:border-neutral-700 dark:hover:border-neutral-600"
                      }`}
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="p-0.5 rounded-geist-sm text-geist-mute dark:text-neutral-300 hover:text-geist-ink dark:hover:text-white transition-colors"
                    title="Edit tag"
                  >
            ...
            <div className="flex items-center gap-3 pt-3 border-t border-geist-hairline dark:border-neutral-800">
              <Link
                ...
                className="text-caption text-geist-mute dark:text-neutral-300 hover:text-geist-ink dark:hover:text-white flex items-center gap-1 transition-colors"
              >
              ...
              <div className="flex items-center gap-1 text-caption text-geist-mute dark:text-neutral-300 ml-auto">
